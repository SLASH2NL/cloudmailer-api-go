...
package cloudmailer
// AutomationShowNameResponse struct for AutomationShowNameResponse
type AutomationShowNameResponse struct {
	Data AutomationShowNameResponseData `json:"data,omitempty"`
}
