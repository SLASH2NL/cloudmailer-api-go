...
package cloudmailer
// AutomationSendRequest struct for AutomationSendRequest
type AutomationSendRequest struct {
	Recipients []AutomationSendRequestRecipients `json:"recipients,omitempty"`
}
