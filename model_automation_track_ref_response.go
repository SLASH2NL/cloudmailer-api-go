...
package cloudmailer
// AutomationTrackRefResponse struct for AutomationTrackRefResponse
type AutomationTrackRefResponse struct {
	Data []AutomationTrackIdResponseData `json:"data,omitempty"`
}
