...
package cloudmailer
// FlowConfigTriggerRequest struct for FlowConfigTriggerRequest
type FlowConfigTriggerRequest struct {
	Groups []FlowConfigRequestGroup `json:"groups,omitempty"`
	DynamicGroups []FlowConfigRequestDynamicGroup `json:"dynamic_groups,omitempty"`
