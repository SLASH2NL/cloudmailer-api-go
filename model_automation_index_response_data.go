...
package cloudmailer
// AutomationIndexResponseData struct for AutomationIndexResponseData
type AutomationIndexResponseData struct {
	...
	Template AutomationIndexResponseTemplate `json:"template,omitempty"`
}
