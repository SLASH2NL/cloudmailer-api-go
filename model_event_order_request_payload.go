...
package cloudmailer
// EventOrderRequestPayload struct for EventOrderRequestPayload
type EventOrderRequestPayload struct {
	// Locale defined as ISO 639-1(nl) or the combination of ISO 639-1 and ISO 3166-1(nl_BE)
	Locale string `json:"locale,omitempty"`
	BillingAddress ReplacementAddress `json:"billing_address,omitempty"`
	DeliveryAddress ReplacementAddress `json:"delivery_address,omitempty"`
	Order ReplacementOrder `json:"order,omitempty"`
}
