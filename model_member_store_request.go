...
package cloudmailer
// MemberStoreRequest struct for MemberStoreRequest
type MemberStoreRequest struct {
	Email string `json:"email,omitempty"`
	MetaFields []MemberRequestMetaField `json:"meta_fields,omitempty"`
	Groups []MemberRequestGroup `json:"groups,omitempty"`
	Automation MemberStoreRequestAutomation `json:"automation,omitempty"`
}
