...
package cloudmailer
// EventOrderTrackAndTraceRequest struct for EventOrderTrackAndTraceRequest
type EventOrderTrackAndTraceRequest struct {
	Email string `json:"email,omitempty"`
	Payload EventOrderTrackAndTraceRequestPayload `json:"payload,omitempty"`
}
