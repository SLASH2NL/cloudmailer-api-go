...
package cloudmailer
// AutomationSendRequestRecipients struct for AutomationSendRequestRecipients
type AutomationSendRequestRecipients struct {
	...
	Attachments []AutomationSendRequestAttachments `json:"attachments,omitempty"`
